...
OFILES = base/imgproc.o base/fftimgproc.o base/LinearWaveEstimate.o base/fftanalysis.o
...
paint:	base/img_paint.C	$(OFILES)
	$(CXX) base/img_paint.C $(INCLUDES) $(GLLDFLAGS) -L ./lib -limgproc $(OIIOLIB) -lfftw3 -o img_paint
